...
public class FragmentHome extends Fragment {
    ...
    //List Tempat
    LatLng matpeci = new LatLng(-6.414772372022273, 107.46725066072548);
    LatLng hardtop = new LatLng(-6.417633165621311, 107.47067297385188);
    LatLng darkan = new LatLng(-6.413488006176021, 107.46761621643142);
    LatLng dali = new LatLng(-6.405630231012807, 107.46217578119527);
    LatLng joss = new LatLng(-6.417968537482714, 107.47020699123053);
